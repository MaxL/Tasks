<?php
    ...
    $newtask[TASK_TYPE] = $_POST['taskType'];
    $newtask[REFERENCE] = $_POST['taskRef'];
    ...
    $taskdata[TASK_TITLE] = htmlspecialchars($_POST['taskTitle']);
    $taskdata[TASK_DATE] = htmlspecialchars($_POST['dateAssigned']);
    $taskdata[DATE_DUE] = htmlspecialchars($_POST['dateDue']);
    $taskdata[TASK_TYPE] = $_POST['taskType'];
    $taskdata[REFERENCE] = $_POST['taskRef'];
    $taskdata[PERC_COMPLETE] = null;
    $taskdata[DATE_COMPLTED] = null;
    $taskdata[TASK_DESC] = $_POST['taskDesc'];
